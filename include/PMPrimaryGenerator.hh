...
private:
  ...
  G4double fBaseEnergy;   // merkez enerji
  G4double fEnergySigma;  // Gauss sigma
  G4double fSourcePosZ;   // kaynak z
  G4double fSourceRadius; // (kullanılmıyor)
  G4double fBeamTheta;    // demet açısı
};
